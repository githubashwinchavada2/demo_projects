...
public class LoggingFilterConfig extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        List<String> pathsToExclude = Arrays.asList("swagger-ui");
        ...
        Boolean isPathExcluded = pathsToExclude.stream().anyMatch(path -> requestWrapper.getRequestURI().contains(path));
